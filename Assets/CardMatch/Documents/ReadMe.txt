Card Match Game Example

Thank you for buying this package!
For those who want to make card match game for the first time will help.

Overview:
	- To make it easier for beginners to understand 
	  the short length of the source code was created.
	- Youtube Link : http://youtu.be/NXVi2PihYxw
...
Note:
	...
	- This app is example for beginners making card match game.
